module suilfg_launch::bonding_curve {
    ...
    public entry fun seed_pool_prepare<T: drop + store>(
        ...
        let p_target_u128 = (p_curve_u128 * u128::from64(10_000 + use_bps)) / u128::from64(10_000);
    ...
    public fun spot_price_u128<T: drop + store>(curve: &BondingCurve<T>): u128 {
        ...
        let s128 = u128::from64(s);
        (u128::from64(curve.m_num) * s128 * s128) / u128::from64(curve.m_den)
    }
