...
module.exports = {
  apps: [
    ...
    // ============================================
    // 5. MAINNET INDEXER - Blockchain Event Monitor (MAINNET)
    // ============================================
    {
      ...
      watch: false,
      max_memory_restart: '500M',
      env_file: '.env.mainnet', // Load MAINNET environment variables
      env: {
        NODE_ENV: 'production',
      },
      error_file: './logs/mainnet-indexer-error.log',
      out_file: './logs/mainnet-indexer-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      merge_logs: true,
      autorestart: true,
      max_restarts: 10,
    ...
    // ============================================
    // 6. MAINNET API - REST API Server (MAINNET)
    // ============================================
    {
      name: 'mainnet-api',
      script: 'api-server.js',
      ...
      error_file: './logs/mainnet-api-error.log',
      out_file: './logs/mainnet-api-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      merge_logs: true,
      autorestart: true,
      max_restarts: 10,
