module suilfg_launch_mainnet::bonding_curve {
    ...
    // Use native SUI for mainnet (no faucet token needed)
    // SUILFG_MEMEFI is replaced with SUI for mainnet deployment

    use suilfg_launch_mainnet::platform_config as platform_config;
    use suilfg_launch_mainnet::platform_config::{PlatformConfig, AdminCap};
    use suilfg_launch_mainnet::referral_registry::{Self, ReferralRegistry};
    use suilfg_launch_mainnet::ticker_registry::{Self as ticker_registry, TickerRegistry};
    ...
    // use suilfg_launch_mainnet::lp_locker::{Self, LockedLPPosition};
