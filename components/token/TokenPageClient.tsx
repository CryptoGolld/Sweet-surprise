...
export function TokenPageClient({ tokenId }: TokenPageClientProps) {
  ...
  const tokens = (tokensResponse?.tokens as IndexedToken[] | undefined) ?? [];
      ...
      <div className="min-h-screen pb-20 md:pb-0 bg-sui-dark">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="text-center py-20">
            ...
            <div className="animate-spin inline-block w-8 h-8 border-4 border-meme-purple border-t-transparent rounded-full" />
          </div>
        </main>
        <BottomNav />
      </div>
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="text-center py-20">
            ...
            <div className="flex items-center justify-center gap-2 text-meme-purple">
              <div className="animate-spin inline-block w-6 h-6 border-4 border-meme-purple border-t-transparent rounded-full" />
              ...
              <div className="bg-white/5 rounded-lg p-3 space-y-1">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold">
                    {tradePreview.output.toFixed(4)} {mode === 'buy' ? token.ticker : getPaymentTokenSymbol()}
                  </span>
                </div>
              </div>
            )}
